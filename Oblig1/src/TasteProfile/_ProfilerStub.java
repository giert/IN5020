...
public class _ProfilerStub extends org.omg.CORBA.portable.ObjectImpl implements TasteProfile.Profiler
{
  ...
  public TasteProfile.TopThreeUsers getTopThreeUsersBySong (String song_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_string (song_id);
                $in = _invoke ($out);
                TasteProfile.TopThreeUsers $result = TasteProfile.TopThreeUsersHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public TasteProfile.TopThreeSongs getTopThreeSongsByUser (String user_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_string (user_id);
                $in = _invoke ($out);
                TasteProfile.TopThreeSongs $result = TasteProfile.TopThreeSongsHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return getTopThreeSongsByUser (user_id        );
            } finally {
                _releaseReply ($in);
            }
